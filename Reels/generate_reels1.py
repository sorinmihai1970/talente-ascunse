"""
Reels 1 Generator - imagini statice + text overlay -> MP4 vertical 1080x1920
MoviePy 2.x + Pillow
"""
...
# ── Configurare ───────────────────────────────────────────────────────────────
INPUT_FOLDER  = r"D:\Sorin\SIM\AI\Ale mele\Excedo\Daria\Code\1"
OUTPUT_FILE   = os.path.join(INPUT_FOLDER, "Reels1_text.mp4")
W, H          = 1080, 1920
DURATION      = 4.0
FADE          = 0.3
